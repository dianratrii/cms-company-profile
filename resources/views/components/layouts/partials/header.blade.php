            ...
            <div class="flex flex-col">
             ...
             <span class="menu-icon">
              ...
              My Profile
                ...
                <div class="menu-item" data-menu-item-offset="-50px, 0" data-menu-item-placement="left-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover"></div>
                <div class="menu-item"></div>
                <div class="menu-item" data-menu-item-offset="-10px, 0" data-menu-item-placement="left-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover"></div>
            </div>
            <div class="flex flex-col">
